...
#define MAX_MEMORY_LEN       65536

// Stack memory adresses
#define STACK_START_ADDR_6502 0x00
#define STACK_END_ADDR_6502   0xFF
#define STACK_ADDR_6502_OFFSET 0xFF
